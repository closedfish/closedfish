...
#include <iostream>
/*
 *@brief Translate the initial board to just pawns (1 are pawns of the bottom
 *player and 2 are pawns of top player)
...
/*
 *@brief From the board with just pawns it returns a list with the position of
 *the most advanced pawn of the bottom player.
...
/*
 *@brief From the board with just pawns it returns a list with the position of
 *the most advanced pawn of the top player.
 *@param  PawnsBoard The board with just pawns
 *@return List of positions for each column
 */
