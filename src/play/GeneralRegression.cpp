...
#pragma region declarations
	...
	std::vector<std::vector<int>> Y(200);
	Y[1] = std::vector<int>({-1, 3, 5, 6, 4, 3, -1, 4});
	Y[0] = std::vector<int>({8, 2, 4, 5, 3, 2, 8, 3});
	Y[3] = std::vector<int>({6, 4, 6, 6, 6, -1, 4, -1});
	Y[2] = std::vector<int>({5, 3, 5, 5, 5, 8, 3, 8});
	Y[5] = std::vector<int>({-1, 3, 4, 2, -1, 6, 3, 5});
	Y[4] = std::vector<int>({8, 2, 3, 1, 8, 5, 2, 4});
	Y[7] = std::vector<int>({6, 2, 3, -1, -1, 6, 4, 2});
	Y[6] = std::vector<int>({5, 1, 2, 8, 8, 5, 3, 1});
	Y[9] = std::vector<int>({5, 4, 6, 4, 6, 2, -1, -1});
	Y[8] = std::vector<int>({4, 3, 5, 3, 5, 1, 8, 8});
	Y[11] = std::vector<int>({-1, 5, 5, 4, 5, 3, -1, 6});
	Y[10] = std::vector<int>({8, 4, 4, 3, 4, 2, 8, 5});
	Y[13] = std::vector<int>({-1, 3, 3, 5, 5, 4, 6, -1});
	Y[12] = std::vector<int>({8, 2, 2, 4, 4, 3, 5, 8});
	Y[15] = std::vector<int>({-1, -1, 5, 2, 2, 2, 4, 3});
	Y[14] = std::vector<int>({8, 8, 4, 1, 1, 1, 3, 2});
	Y[17] = std::vector<int>({6, 6, 3, 6, -1, -1, 2, 5});
	Y[16] = std::vector<int>({5, 5, 2, 5, 8, 8, 1, 4});
	Y[19] = std::vector<int>({6, -1, 5, 3, -1, 4, 5, 3});
	Y[18] = std::vector<int>({5, 8, 4, 2, 8, 3, 4, 2});
	Y[21] = std::vector<int>({5, 4, 4, 4, -1, 5, 2, -1});
	Y[20] = std::vector<int>({4, 3, 3, 3, 8, 4, 1, 8});
	Y[23] = std::vector<int>({5, -1, 3, 3, 6, 3, -1, 3});
	Y[22] = std::vector<int>({4, 8, 2, 2, 5, 2, 8, 2});
	Y[25] = std::vector<int>({-1, 5, 3, 4, 2, 3, -1, 5});
	Y[24] = std::vector<int>({8, 4, 2, 3, 1, 2, 8, 4});
	Y[27] = std::vector<int>({5, 5, -1, 5, 5, 5, -1, 3});
	Y[26] = std::vector<int>({4, 4, 8, 4, 4, 4, 8, 2});
	Y[29] = std::vector<int>({6, 6, -1, 3, -1, 3, 6, 4});
	Y[28] = std::vector<int>({5, 5, 8, 2, 8, 2, 5, 3});
	Y[31] = std::vector<int>({5, 5, 6, -1, 3, -1, 6, 2});
	Y[30] = std::vector<int>({4, 4, 5, 8, 2, 8, 5, 1});
	Y[33] = std::vector<int>({4, -1, -1, 2, 2, 6, 5, 6});
	Y[32] = std::vector<int>({3, 8, 8, 1, 1, 5, 4, 5});
	Y[35] = std::vector<int>({3, 2, -1, -1, 2, 3, 6, 4});
	Y[34] = std::vector<int>({2, 1, 8, 8, 1, 2, 5, 3});
	Y[37] = std::vector<int>({3, 2, 2, -1, 5, -1, 2, 5});
	Y[36] = std::vector<int>({2, 1, 1, 8, 4, 8, 1, 4});
	Y[39] = std::vector<int>({5, 5, -1, 5, 3, 3, 3, -1});
	Y[38] = std::vector<int>({4, 4, 8, 4, 2, 2, 2, 8});
	Y[41] = std::vector<int>({4, -1, 2, 5, -1, 2, 6, 4});
	Y[40] = std::vector<int>({3, 8, 1, 4, 8, 1, 5, 3});
	Y[43] = std::vector<int>({6, 5, 4, -1, -1, 5, 6, 3});
	Y[42] = std::vector<int>({5, 4, 3, 8, 8, 4, 5, 2});
	Y[45] = std::vector<int>({3, 2, 6, -1, 5, -1, 6, 3});
	Y[44] = std::vector<int>({2, 1, 5, 8, 4, 8, 5, 2});
	Y[47] = std::vector<int>({-1, 6, -1, 3, 6, 6, 5, 5});
	Y[46] = std::vector<int>({8, 5, 8, 2, 5, 5, 4, 4});
	Y[49] = std::vector<int>({-1, 5, 4, 3, 4, -1, 2, 2});
	Y[48] = std::vector<int>({8, 4, 3, 2, 3, 8, 1, 1});
	Y[51] = std::vector<int>({6, 4, 2, -1, 3, 3, -1, 5});
	Y[50] = std::vector<int>({5, 3, 1, 8, 2, 2, 8, 4});
	Y[53] = std::vector<int>({-1, 3, 2, 2, 3, 4, -1, 6});
	Y[52] = std::vector<int>({8, 2, 1, 1, 2, 3, 8, 5});
	Y[55] = std::vector<int>({-1, -1, 5, 6, 3, 5, 2, 4});
	Y[54] = std::vector<int>({8, 8, 4, 5, 2, 4, 1, 3});
	Y[57] = std::vector<int>({4, 6, 4, -1, 3, -1, 2, 2});
	Y[56] = std::vector<int>({3, 5, 3, 8, 2, 8, 1, 1});
	Y[59] = std::vector<int>({-1, 5, 4, -1, 5, 6, 4, 3});
	Y[58] = std::vector<int>({8, 4, 3, 8, 4, 5, 3, 2});
	Y[61] = std::vector<int>({4, 2, 3, -1, 4, 6, -1, 3});
	Y[60] = std::vector<int>({3, 1, 2, 8, 3, 5, 8, 2});
	Y[63] = std::vector<int>({4, 6, -1, 5, 6, 4, -1, 3});
	Y[62] = std::vector<int>({3, 5, 8, 4, 5, 3, 8, 2});
	Y[65] = std::vector<int>({3, 6, -1, 3, 5, -1, 3, 4});
	Y[64] = std::vector<int>({2, 5, 8, 2, 4, 8, 2, 3});
	Y[67] = std::vector<int>({4, 3, 4, -1, 6, 2, 2, -1});
	Y[66] = std::vector<int>({3, 2, 3, 8, 5, 1, 1, 8});
	Y[69] = std::vector<int>({5, -1, -1, 6, 5, 6, 2, 6});
	Y[68] = std::vector<int>({4, 8, 8, 5, 4, 5, 1, 5});
	Y[71] = std::vector<int>({6, 5, -1, 3, 3, 6, 3, -1});
	Y[70] = std::vector<int>({5, 4, 8, 2, 2, 5, 2, 8});
	Y[73] = std::vector<int>({-1, 2, 4, 6, 5, 6, -1, 3});
	Y[72] = std::vector<int>({8, 1, 3, 5, 4, 5, 8, 2});
	Y[75] = std::vector<int>({6, 3, 3, -1, 5, 6, 3, -1});
	Y[74] = std::vector<int>({5, 2, 2, 8, 4, 5, 2, 8});
	Y[77] = std::vector<int>({4, 5, 6, 2, 2, -1, 6, -1});
	Y[76] = std::vector<int>({3, 4, 5, 1, 1, 8, 5, 8});
	Y[79] = std::vector<int>({5, 3, 4, -1, -1, 2, 2, 2});
	Y[78] = std::vector<int>({4, 2, 3, 8, 8, 1, 1, 1});
	Y[81] = std::vector<int>({5, 6, 2, -1, 6, -1, 3, 4});
	Y[80] = std::vector<int>({4, 5, 1, 8, 5, 8, 2, 3});
	Y[83] = std::vector<int>({-1, -1, 2, 2, 5, 3, 4, 3});
	Y[82] = std::vector<int>({8, 8, 1, 1, 4, 2, 3, 2});
	Y[85] = std::vector<int>({-1, 5, -1, 6, 5, 2, 3, 3});
	Y[84] = std::vector<int>({8, 4, 8, 5, 4, 1, 2, 2});
	Y[87] = std::vector<int>({3, 2, 6, -1, 2, 4, -1, 2});
	Y[86] = std::vector<int>({2, 1, 5, 8, 1, 3, 8, 1});
	Y[89] = std::vector<int>({4, 6, -1, 2, 6, 6, 5, -1});
	Y[88] = std::vector<int>({3, 5, 8, 1, 5, 5, 4, 8});
	Y[91] = std::vector<int>({4, -1, 3, 2, 4, 4, 5, -1});
	Y[90] = std::vector<int>({3, 8, 2, 1, 3, 3, 4, 8});
	Y[93] = std::vector<int>({4, 3, 5, -1, -1, 4, 6, 3});
	Y[92] = std::vector<int>({3, 2, 4, 8, 8, 3, 5, 2});
	Y[95] = std::vector<int>({6, 5, 2, -1, 2, -1, 4, 6});
	Y[94] = std::vector<int>({5, 4, 1, 8, 1, 8, 3, 5});
	Y[97] = std::vector<int>({-1, 3, 5, 4, 3, -1, 4, 6});
	Y[96] = std::vector<int>({8, 2, 4, 3, 2, 8, 3, 5});
	Y[99] = std::vector<int>({-1, 2, 5, -1, 6, 6, 4, 6});
	Y[98] = std::vector<int>({8, 1, 4, 8, 5, 5, 3, 5});
	Y[101] = std::vector<int>({-1, 6, 6, 5, 6, -1, 2, 6});
	Y[100] = std::vector<int>({8, 5, 5, 4, 5, 8, 1, 5});
	Y[103] = std::vector<int>({3, 2, 5, -1, 5, 6, 5, -1});
	Y[102] = std::vector<int>({2, 1, 4, 8, 4, 5, 4, 8});
	Y[105] = std::vector<int>({-1, -1, 4, 4, 2, 6, 3, 6});
	Y[104] = std::vector<int>({8, 8, 3, 3, 1, 5, 2, 5});
	Y[107] = std::vector<int>({4, 3, -1, 6, 2, -1, 5, 4});
	Y[106] = std::vector<int>({3, 2, 8, 5, 1, 8, 4, 3});
	Y[109] = std::vector<int>({5, 3, 5, -1, 2, 3, -1, 4});
	Y[108] = std::vector<int>({4, 2, 4, 8, 1, 2, 8, 3});
	Y[111] = std::vector<int>({5, 5, 6, 3, 5, 4, -1, -1});
	Y[110] = std::vector<int>({4, 4, 5, 2, 4, 3, 8, 8});
	Y[113] = std::vector<int>({-1, 2, 6, 6, 4, 5, -1, 2});
	Y[112] = std::vector<int>({8, 1, 5, 5, 3, 4, 8, 1});
	Y[115] = std::vector<int>({-1, 4, 2, 2, 6, -1, 3, 3});
	Y[114] = std::vector<int>({8, 3, 1, 1, 5, 8, 2, 2});
	Y[117] = std::vector<int>({4, 4, -1, 4, 6, 4, 4, -1});
	Y[116] = std::vector<int>({3, 3, 8, 3, 5, 3, 3, 8});
	Y[119] = std::vector<int>({6, 4, 6, 2, 5, -1, 3, -1});
	Y[118] = std::vector<int>({5, 3, 5, 1, 4, 8, 2, 8});
	Y[121] = std::vector<int>({6, -1, 3, 6, 4, 6, -1, 2});
	Y[120] = std::vector<int>({5, 8, 2, 5, 3, 5, 8, 1});
	Y[123] = std::vector<int>({5, 5, -1, 5, -1, 4, 4, 4});
	Y[122] = std::vector<int>({4, 4, 8, 4, 8, 3, 3, 3});
	Y[125] = std::vector<int>({5, 6, 2, 2, 4, -1, -1, 5});
	Y[124] = std::vector<int>({4, 5, 1, 1, 3, 8, 8, 4});
	Y[127] = std::vector<int>({6, 6, 4, -1, 5, -1, 2, 5});
	Y[126] = std::vector<int>({5, 5, 3, 8, 4, 8, 1, 4});
	Y[129] = std::vector<int>({6, -1, 4, 6, 6, -1, 4, 5});
	Y[128] = std::vector<int>({5, 8, 3, 5, 5, 8, 3, 4});
	Y[131] = std::vector<int>({-1, 4, 6, 5, -1, 3, 4, 3});
	Y[130] = std::vector<int>({8, 3, 5, 4, 8, 2, 3, 2});
	Y[133] = std::vector<int>({-1, 6, 4, -1, 5, 5, 5, 6});
	Y[132] = std::vector<int>({8, 5, 3, 8, 4, 4, 4, 5});
	Y[135] = std::vector<int>({-1, 5, 4, 5, -1, 3, 5, 2});
	Y[134] = std::vector<int>({8, 4, 3, 4, 8, 2, 4, 1});
	Y[137] = std::vector<int>({3, -1, 5, -1, 3, 6, 2, 4});
	Y[136] = std::vector<int>({2, 8, 4, 8, 2, 5, 1, 3});
	Y[139] = std::vector<int>({3, -1, 4, -1, 5, 2, 2, 4});
	Y[138] = std::vector<int>({2, 8, 3, 8, 4, 1, 1, 3});
	Y[141] = std::vector<int>({-1, 3, 6, 2, -1, 5, 4, 2});
	Y[140] = std::vector<int>({8, 2, 5, 1, 8, 4, 3, 1});
	Y[143] = std::vector<int>({5, 3, 6, 2, -1, 4, -1, 6});
	Y[142] = std::vector<int>({4, 2, 5, 1, 8, 3, 8, 5});
	Y[145] = std::vector<int>({6, 5, 3, 3, -1, 2, 3, -1});
	Y[144] = std::vector<int>({5, 4, 2, 2, 8, 1, 2, 8});
	Y[147] = std::vector<int>({6, 5, 2, 2, 2, -1, 2, -1});
	Y[146] = std::vector<int>({5, 4, 1, 1, 1, 8, 1, 8});
	Y[149] = std::vector<int>({-1, 6, 6, 3, 6, -1, 6, 4});
	Y[148] = std::vector<int>({8, 5, 5, 2, 5, 8, 5, 3});
	Y[151] = std::vector<int>({6, -1, 4, -1, 2, 2, 2, 2});
	Y[150] = std::vector<int>({5, 8, 3, 8, 1, 1, 1, 1});
	Y[153] = std::vector<int>({3, -1, 2, -1, 5, 3, 5, 6});
	Y[152] = std::vector<int>({2, 8, 1, 8, 4, 2, 4, 5});
	Y[155] = std::vector<int>({-1, 3, 6, 5, -1, 4, 6, 2});
	Y[154] = std::vector<int>({8, 2, 5, 4, 8, 3, 5, 1});
	Y[157] = std::vector<int>({-1, 4, 5, 6, 2, -1, 6, 3});
	Y[156] = std::vector<int>({8, 3, 4, 5, 1, 8, 5, 2});
	Y[159] = std::vector<int>({6, -1, 4, -1, 6, 4, 2, 5});
	Y[158] = std::vector<int>({5, 8, 3, 8, 5, 3, 1, 4});
	Y[161] = std::vector<int>({-1, -1, 2, 5, 2, 4, 2, 3});
	Y[160] = std::vector<int>({8, 8, 1, 4, 1, 3, 1, 2});
	Y[163] = std::vector<int>({5, 5, -1, -1, 6, 3, 2, 4});
	Y[162] = std::vector<int>({4, 4, 8, 8, 5, 2, 1, 3});
	Y[165] = std::vector<int>({-1, 4, 3, 4, 4, -1, 4, 3});
	Y[164] = std::vector<int>({8, 3, 2, 3, 3, 8, 3, 2});
	Y[167] = std::vector<int>({4, -1, 6, 3, 6, -1, 6, 5});
	Y[166] = std::vector<int>({3, 8, 5, 2, 5, 8, 5, 4});
	Y[169] = std::vector<int>({5, -1, 2, 5, 2, -1, 3, 4});
	Y[168] = std::vector<int>({4, 8, 1, 4, 1, 8, 2, 3});
	Y[171] = std::vector<int>({-1, 2, 5, 5, -1, 5, 5, 3});
	Y[170] = std::vector<int>({8, 1, 4, 4, 8, 4, 4, 2});
	Y[173] = std::vector<int>({4, -1, 4, -1, 2, 4, 3, 6});
	Y[172] = std::vector<int>({3, 8, 3, 8, 1, 3, 2, 5});
	Y[175] = std::vector<int>({3, 6, 4, -1, 2, 4, 3, -1});
	Y[174] = std::vector<int>({2, 5, 3, 8, 1, 3, 2, 8});
	Y[177] = std::vector<int>({4, 6, 6, 3, -1, 4, 2, -1});
	Y[176] = std::vector<int>({3, 5, 5, 2, 8, 3, 1, 8});
	Y[179] = std::vector<int>({-1, 2, -1, 2, 3, 5, 5, 6});
	Y[178] = std::vector<int>({8, 1, 8, 1, 2, 4, 4, 5});
	Y[181] = std::vector<int>({5, 2, 4, 5, 3, -1, 4, -1});
	Y[180] = std::vector<int>({4, 1, 3, 4, 2, 8, 3, 8});
	Y[183] = std::vector<int>({5, 4, 6, -1, 2, 3, 3, -1});
	Y[182] = std::vector<int>({4, 3, 5, 8, 1, 2, 2, 8});
	Y[185] = std::vector<int>({5, 3, 6, -1, -1, 4, 4, 2});
	Y[184] = std::vector<int>({4, 2, 5, 8, 8, 3, 3, 1});
	Y[187] = std::vector<int>({5, -1, 3, -1, 5, 4, 2, 3});
	Y[186] = std::vector<int>({4, 8, 2, 8, 4, 3, 1, 2});
	Y[189] = std::vector<int>({5, 2, -1, 3, 4, -1, 5, 3});
	Y[188] = std::vector<int>({4, 1, 8, 2, 3, 8, 4, 2});
	Y[191] = std::vector<int>({3, 4, 4, -1, 4, -1, 5, 3});
	Y[190] = std::vector<int>({2, 3, 3, 8, 3, 8, 4, 2});
	Y[193] = std::vector<int>({3, -1, 2, 2, 4, 5, -1, 6});
	Y[192] = std::vector<int>({2, 8, 1, 1, 3, 4, 8, 5});
	Y[195] = std::vector<int>({5, -1, -1, 6, 6, 5, 5, 3});
	Y[194] = std::vector<int>({4, 8, 8, 5, 5, 4, 4, 2});
	Y[197] = std::vector<int>({6, -1, -1, 2, 3, 6, 3, 6});
	Y[196] = std::vector<int>({5, 8, 8, 1, 2, 5, 2, 5});
	Y[199] = std::vector<int>({3, 6, 2, -1, 3, 5, -1, 2});
	Y[198] = std::vector<int>({2, 5, 1, 8, 2, 4, 8, 1});
