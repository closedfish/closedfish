...
*/
vector<int> Breakthrough2::dfsBreak(CFBoard board, int start, uint64_t ends, float pruneval)
{
	// line of moves
	vector<int> line;
	vector<int> ans;
...
vector<int> Breakthrough2::dfsPruneForce(CFBoard board, int depth, int color, vector<int> v, float eval)
{
	color = color % 2;
	if (depth == 5)
	{
